...
4. Dans le fichier *index.js*, instancie un objet de type `Weapon` avec le nom "Épée", un dommage de 10 et l'image "sword.svg" qui se trouve dans le dossier images. Ensuite associe-le à Héraclès.
...
3. Comme pour l'arme, pense à instancier un bouclier et à l'associer à Héraclès.
