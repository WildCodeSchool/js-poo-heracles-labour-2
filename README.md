...
4. In the *index.js* file, instantiate an object of type `Weapon` with the name "Sword", a damage of 10 and the image "sword.svg" which is located in the images folder. Then associate it with Heracles.
